...
public class CustomerInfo extends javax.swing.JFrame {
     ...
     */
    public CustomerInfo(String cusname, String email, String phone, String birth, String address, String type, String password, String ID) {
        initComponents();
        ...
        jLabel2.setText("Name: " +cusname);

        jLabel3.setText("Email: " +email);

        jLabel4.setText("Phone: " +phone);

        jLabel5.setText("Birth: " +birth);

        jLabel6.setText("Address: " +address);
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        Account account = new Account(cusname,ID);
